...
impl Spongos {
    ...
    pub fn fork(&self, fork: &mut Spongos) {
        unsafe { ffi::mam_mam_spongos_fork(&self.c_spongos, &mut fork.c_spongos) }
    }
    ...
    pub fn commit(&mut self) {
        unsafe { ffi::mam_spongos_commit(&mut self.c_spongos) }
    }
    ...
    pub fn absorb(&mut self, input: &Trits) {
        unsafe { ffi::mam_spongos_absorb(&mut self.c_spongos, input.into_raw()) }
    }
    ...
    pub fn absorbn(&mut self, n: usize, inputs: &mut Trits) {
        unsafe { ffi::mam_spongos_absorbn(&mut self.c_spongos, n, inputs.into_raw_mut()) }
    }
    ...
    pub fn squeeze(&mut self, output: &Trits) {
        unsafe { ffi::mam_spongos_squeeze(&mut self.c_spongos, output.into_raw()) }
    }
    ...
    pub fn squeeze_eq(&mut self, expected_output: &Trits) -> bool {
        unsafe { ffi::mam_spongos_squeeze_eq(&mut self.c_spongos, expected_output.into_raw()) }
    }
    ...
    pub fn hash(&mut self, input: &Trits, output: &Trits) {
        unsafe { ffi::mam_spongos_hash(&mut self.c_spongos, input.into_raw(), output.into_raw()) }
    }
